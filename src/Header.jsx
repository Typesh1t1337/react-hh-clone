                    ...
                    {isAuthenticated ? (
                        isCompany ? (
                            <ul className="w-full flex justify-around items-center text-[#ADB3BF]">
                                ...
                                <li key="applies"><Link to={`/account/vacancies/${user}/applied/`}>Applies list</Link></li>
                ...
                <div className="h-full w-[280px] flex justify-center items-center">
                    {
                        isAuthenticated ? (
                            <div className="h-[56px] w-full flex">
                                ...
                                <div className="h-full w-[60%] flex justify-center items-center">
                                    <div className="h-[50px] w-full flex flex-col justify-between items-end">
                                        ...
                                        <Link to={`/account/profile/${user}`} className="text-[12px]">@{user}</Link>
                                    </div>
                                </div>
                            </div>
                        ) : (
                            <div className="h-[56px] w-full flex">
                                ...
                                <div
                                    className="h-full w-[50%] flex justify-center items-center rounded-[4px] bg-[#1B70F1]">
